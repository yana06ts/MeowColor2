...
export const PUZZLE_TEMPLATES: PuzzleTemplate[] = [
  ...
  },
  {
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Тёмный каркас" },
      { number: 2, hex: "#FFCA28", name: "Золотистый пластик" },
      { number: 3, hex: "#FF8F00", name: "Оранжевые рёбра" },
      { number: 4, hex: "#FF3D00", name: "Внутренняя полость" },
      { number: 5, hex: "#ECEFF1", name: "Звенящий бубенчик сталь" }
    ],
    difficulty: "Medium",
    yarnReward: 70,
    description: "Перфорированный весёлый мячик, внутри которого звонко катается блестящий металлический бубенчик."
  },
  {
    id: "giga_mainecoon",
    name: "Гигантский Мейн-кун 🦁",
    category: "cats",
    width: 24,
    height: 24,
    rows: [
      ...
      "....132231....132231....",
      "...132222311113222231...",
      "..13222222333322222231..",
      "..12222222222222222221..",
      ".1222332222222222332221.",
      ".1223333222222223333221.",
      "122223322222222223322221",
      "122222227722227722222221",
      "122222274472274472222221",
      "122222227722227722222221",
      "122266222225522222266221",
      ".1222222221111222222221.",
      "..12222221444412222221..",
      "...122221444444122221...",
      "....1121444444441211....",
      ".....11144444444111.....",
      "......114444444411......",
    ...
    colors: [
      { number: 1, hex: "#1A1A1D", name: "Контур угля" },
      { number: 2, hex: "#E0A96D", name: "Золотисто-рыжий мех" },
      { number: 3, hex: "#965A38", name: "Шоколадные полосы" },
      { number: 4, hex: "#FFFFFF", name: "Белая грудка" },
      { number: 5, hex: "#F06292", name: "Розовый носик" },
      { number: 6, hex: "#FFF9C4", name: "Сливочные щёчки" },
      { number: 7, hex: "#81C784", name: "Изумрудные глаза" }
    ],
    difficulty: "Expert",
    yarnReward: 200,
    description: "Величественный пушистый гигант с кисточками на ушках и роскошным воротником."
  },
  {
    id: "cozy_teatime",
    name: "Шотландский Вислоушка 🪐🐱",
    category: "cats",
    width: 24,
    height: 24,
    rows: [
      ...
      "....124421....124421....",
      "...124224211112422421...",
      "..12422224222242222421..",
      "..12222222222222222221..",
      ".1222255222222225522221.",
      ".1222533522222253352221.",
      "122225335222222533522221",
      "122222552222222255222221",
      "122222222227722222222221",
      "122222222276672222222221",
      "122228822222222222882221",
      ".1228888222222228888221.",
      "..12288222111122288221..",
      "...122222122221222221...",
      "....1122212222122211....",
      ".....11111222211111.....",
      ".........11111..........",
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Контур шерсти" },
      { number: 2, hex: "#B0BEC5", name: "Серебристый мех" },
      { number: 3, hex: "#1E1F22", name: "Угольные зрачки" },
      { number: 4, hex: "#78909C", name: "Пепельные тени" },
      { number: 5, hex: "#FFCA28", name: "Янтарные глазки" },
      { number: 6, hex: "#FF8A80", name: "Розовый носик" },
      { number: 7, hex: "#FF3D00", name: "Алый ошейник" },
      { number: 8, hex: "#FFF9C4", name: "Светлые щечки" }
    ],
    difficulty: "Expert",
    yarnReward: 220,
    description: "Милейший шотландский вислоухий котик с огромными янтарными глазами и серебристо-пепельной мягкой шубкой."
  },
  {
    id: "mega_cat_castle",
    name: "Замок Котиков 🏰🐾",
    ...
    rows: [
      ...
      "...411132231132231114...",
      "...411322223322223114...",
      "..41112222222222221114..",
      "..41112255222255221114..",
      "..41112555522555521114..",
      "..41112255222255221114..",
      "..41112222266222221114..",
      "...411122222222221114...",
      "....4111111111111114....",
      ".....44111111111144.....",
      "......114444444411......",
    ...
    colors: [
      { number: 1, hex: "#4E342E", name: "Деревянные опоры" },
      { number: 2, hex: "#FFF8E7", name: "Сливочный мех" },
      { number: 3, hex: "#8D6E63", name: "Коричневые ушки" },
      { number: 4, hex: "#2F2E36", name: "Контур башен" },
      { number: 5, hex: "#42A5F5", name: "Небесные глазки" },
      { number: 6, hex: "#FF8A80", name: "Розовые щечки" },
      { number: 7, hex: "#B0BEC5", name: "Каменные плиты" },
      { number: 8, hex: "#78909C", name: "Стальные цепи" }
    ],
    difficulty: "Expert",
    yarnReward: 250,
    description: "Настоящий пушистый замок мечты со встроенными когтеточками, башенками, гамаками и пушистыми жителями!"
  },
  {
    id: "cosmic_kitty_ship",
    name: "Кото-Ракета 🚀🌌",
    category: "cats",
    width: 24,
    height: 24,
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Темный корпус" },
      { number: 2, hex: "#ECEFF1", name: "Стальная обшивка" },
      { number: 3, hex: "#FF1744", name: "Красные крылья" },
      { number: 4, hex: "#FFD600", name: "Огненный иллюминатор" },
      { number: 5, hex: "#3F51B5", name: "Чернильный космос" },
      { number: 6, hex: "#00E5FF", name: "Реактивный след" },
      { number: 7, hex: "#FF6D00", name: "Яркое пламя" },
      { number: 8, hex: "#FFD600", name: "Искры плазмы" }
    ],
    difficulty: "Expert",
    yarnReward: 240,
    description: "Высокотехнологичный кошачий корабль, несущийся сквозь туманности к неизведанным созвездиям рыбного паштета!"
  }
];
...
export const GACHA_EXCLUSIVE_PUZZLES: PuzzleTemplate[] = [
  {
    id: "gacha_space_cat",
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Контур" },
      { number: 2, hex: "#4A148C", name: "Темный космос" },
      { number: 3, hex: "#BA68C8", name: "Туманность" },
      { number: 4, hex: "#FFEB3B", name: "Звездные глаза" },
      { number: 5, hex: "#00E5FF", name: "Аква нео-щечки" }
    ],
    difficulty: "Expert",
    yarnReward: 160,
    description: "Настоящий межгалактический пушистик с мерцающей шерсткой цвета туманности."
  },
  {
    id: "gacha_dragon_fruit",
    name: "Драконий фрукт 🥝💖",
    category: "cozy food",
    width: 16,
    height: 16,
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Силуэт" },
      { number: 2, hex: "#C2185B", name: "Кожура питахайи" },
      { number: 3, hex: "#F8BBD0", name: "Нежная мякоть" },
      { number: 4, hex: "#4CAF50", name: "Зеленые чешуйки" },
      { number: 5, hex: "#1E1F22", name: "Сладкие семечки" }
    ],
    difficulty: "Medium",
    yarnReward: 140,
    description: "Экзотический драконий фрукт прямо из лавки сладостей с сочным тропическим ароматом."
  },
  {
    id: "gacha_starfish",
    name: "Морская звезда ⭐✨",
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Контур лап" },
      { number: 2, hex: "#FFD54F", name: "Теплый солнечный" },
      { number: 3, hex: "#FF8F00", name: "Оранжевый загар" },
      { number: 4, hex: "#E91E63", name: "Милые глазки" },
      { number: 5, hex: "#FFFFFF", name: "Искры веселья" }
    ],
    difficulty: "Medium",
    yarnReward: 130,
    description: "Улыбающаяся шуршащая звездочка с пляжа — излюбленная игрушка всех пушистых искателей приключений."
  },
  {
    id: "gacha_neon_cactus",
    name: "Неоновый кактус 🌵🌸",
    category: "plants & buds",
    width: 16,
    height: 16,
    rows: [
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Угольный горшок" },
      { number: 2, hex: "#00897B", name: "Сочный стебель" },
      { number: 3, hex: "#4DB6AC", name: "Бирюзовые колючки" },
      { number: 4, hex: "#FF4081", name: "Неоновый цветок" },
      { number: 5, hex: "#8D6E63", name: "Глиняное кашпо" }
    ],
    difficulty: "Medium",
    yarnReward: 125,
    description: "Чудесный пустынный кактус, сияющий приятным неоновым светом и радующий ярким цветком на макушке."
  }
];
...
export const LEVEL_SEQUENCE: LevelItem[] = [
  // Cycle 1: Космическое приключение
  { puzzleId: "toy_yarn_ball", isSuper: false, cycleNumber: 1 },
  { puzzleId: "cute_strawberry", isSuper: false, cycleNumber: 1 },
  { puzzleId: "happy_cactus", isSuper: false, cycleNumber: 1 },
  { puzzleId: "siamese_cat", isSuper: true, cycleNumber: 1 },

  // Cycle 2: Восточные легенды
  { puzzleId: "squeaky_mouse", isSuper: false, cycleNumber: 2 },
  { puzzleId: "glazed_donut", isSuper: false, cycleNumber: 2 },
  { puzzleId: "giant_monstera", isSuper: false, cycleNumber: 2 },
  { puzzleId: "ginger_munchkin", isSuper: true, cycleNumber: 2 },

  // Cycle 3: Уютный садик
  { puzzleId: "toy_fish", isSuper: false, cycleNumber: 3 },
  { puzzleId: "kitty_toast", isSuper: false, cycleNumber: 3 },
  { puzzleId: "succulent_terrarium", isSuper: false, cycleNumber: 3 },
  { puzzleId: "royal_white_cat", isSuper: true, cycleNumber: 3 },

  // Cycle 4: Мяу-Десерты
  { puzzleId: "toy_scratch", isSuper: false, cycleNumber: 4 },
  { puzzleId: "cat_ramen", isSuper: false, cycleNumber: 4 },
  { puzzleId: "cute_mushroom", isSuper: false, cycleNumber: 4 },
  { puzzleId: "calico_cat", isSuper: true, cycleNumber: 4 },

  // Cycle 5: Мега-Холсты 🎨
  { puzzleId: "giga_mainecoon", isSuper: false, cycleNumber: 5 },
  { puzzleId: "cozy_teatime", isSuper: true, cycleNumber: 5 },
  { puzzleId: "mega_cat_castle", isSuper: false, cycleNumber: 5 },
  { puzzleId: "cosmic_kitty_ship", isSuper: true, cycleNumber: 5 }
];
