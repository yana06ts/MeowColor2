...
export const PUZZLE_TEMPLATES: PuzzleTemplate[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      "...133331......133331...",
      "...132233111111332231...",
      "..13222223333332222231..",
      "..13222222222222222231..",
      "..12233222222222233221..",
      ".1223333222222223333221.",
      ".1222332222222222332221.",
      ".1222222772222772222221.",
      "122222274472274472222221",
      "122222227722227722222221",
      "122662222225522222266221",
      "122222222211112222222221",
      ".1222222214444122222221.",
      "..12222214444441222221..",
      "...112214444444412211...",
      "....1221444444441221....",
      "....1221444114441221....",
      "....1222144114412221....",
  ...
  },
  {
    ...
    rows: [
      ...
      ".1222222222222222221....",
      ".1222211222211222221....",
      "122221661221661222221...",
      "122222112222112222221...",
      "122222222222222222111...",
      "122222221111222221..31..",
      ".1222221444412221...331.",
      "..11222144441221....131.",
      "....11111111111.....131.",
      "....................131.",
      "....11111111111.....131.",
    ...
    colors: [
      { number: 1, hex: "#2F2E36", name: "Уютный контур" },
      { number: 2, hex: "#ECEFF1", name: "Белый фарфор" },
      { number: 3, hex: "#FFAB91", name: "Кремовая глазурь" },
      { number: 4, hex: "#FFE082", name: "Тёплый ароматный чай" },
      { number: 5, hex: "#AB47BC", name: "Черничные узоры" },
      { number: 6, hex: "#81C784", name: "Листик мяты" },
      { number: 7, hex: "#FF8A80", name: "Ягода вишни" }
    ],
    difficulty: "Expert",
    yarnReward: 220,
    description: "Уютный праздничный натюрморт: расписной чайник с ушками, чашечка чая и аппетитное пирожное с вишенкой."
  }
];
